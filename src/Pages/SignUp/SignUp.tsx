      ...
      <div className={styles.container}>
        <div className={styles.test}>
          ...
          <div className={styles.inputs}>
            ...
            />
            <Input type={'email'} value={email} onChange={(value: string) => setEmail(value)} placeholder={'Email'} />
            <PhoneInput
            ...
            <div className={styles.passwordContainer}>
              ...
              <div className={styles.eyeIcon} onClick={onEyeClick}>
                {password && type !== 'password' ? <ClosedEyeIcon /> : <OpenEyeIcon />}
              </div>
            </div>
            <div className={styles.passwordContainer}>
              <Input
              ...
              <div className={styles.eyeIcon} onClick={onEyeClickConfirm}>
                {passwordConfirmation && typeConfirm !== 'password' ? <ClosedEyeIcon /> : <OpenEyeIcon />}
              </div>
            </div>
          </div>
