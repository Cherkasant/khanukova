...
const MOCK_CARDSLISTNOTIFICATIONS = [
   CARD_MOCK, CARD_MOCK, CARD_MOCK, CARD_MOCK, CARD_MOCK_TWO
]
...
const NotificationsPage = () => { 
   ...
   return (
      <div className={styles.container}>
         ...
         <TabsListNotifications 
               activeTab={ activeTab }
               onClickedTab={ onTabClick }
               TabsList={TABS_NOTIFICATION_NAMES}
         />
         <div className={styles.blueLine}></div>
         
         <div>
            <CardsListNotifications 
               CardsListNotifications={MOCK_CARDSLISTNOTIFICATIONS}/>
         </div>
      </div>
   );
};
