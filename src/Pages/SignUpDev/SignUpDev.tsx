...
import styles from "./SignUpDev.module.css";
    ...
    <>
      <div className={styles.container}>
        <div className={styles.test}>
          ...
          <Form onFinish={onSignUpDev} form={form} className={styles.form}>
            ...
            <Form.Item className={styles.formItem}>
              <PuzzleButton
                ...
                btnDisabled={
                  !(checkPassword === checkPasswordConfirm) || !checked
                }
              />
            </Form.Item>
          </Form>
