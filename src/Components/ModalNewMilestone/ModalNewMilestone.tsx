...
import { postMilestoneCard, setSelectedModalVisible } from '../../Redux/Reducers/postReducer';
...
const ModalNewMilestone = () => {
  ...
  const [duration, setDuration] = useState<string | undefined>(singleMilestone?.duration.toString());
  ...
  const [title, setTitle] = useState<string | undefined>(singleMilestone?.milestone_name);
            ...
            <div className={styles.inputsBlock}>
              ...
              <div>
                ...
                <Dropdown
                  ...
                  value={singleMilestone?.priority}
              ...
              <div>
                ...
                <Dropdown
                  options={Colors}
                  onChange={setColors}
                  value={singleMilestone?.color_labels}
                  placeholder="Nothing selected"
                  className={styles.dropdownContainer}
                  controlClassName={styles.dropdownControl}
                  placeholderClassName={styles.dropdownPlaceholder}
              ...
              <div>
                ...
                <Dropdown
                  ...
                  value={singleMilestone?.progress.toString()}
                  placeholder="Nothing selected"
                  className={styles.dropdownContainer}
                  controlClassName={styles.dropdownControl}
                  placeholderClassName={styles.dropdownPlaceholder}
              ...
              <div>
                ...
                <Dropdown
                  ...
                  value={singleMilestone?.payment_status}
